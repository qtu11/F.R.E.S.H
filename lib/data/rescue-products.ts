...
/** Product ID → local image filename mapping */
const LOCAL_IMAGE_MAP: Record<string, string> = {
  rp01: 'Rau cải bó xôi.jpg',
  rp02: 'Bông cải xanh Đà Lạt.jpg',
  rp03: 'Cà rốt hữu cơ.jpg',
  rp04: 'Xà lách thủy canh Mỹ.jpg',
  rp05: 'Cà chua Beef Đà Lạt.jpg',
  rp06: 'Nấm đùi gà baby.webp',
  rp07: 'Chuối già Nam Mỹ.jpg',
  rp08: 'Táo Fuji Nam Phi.jpg',
  rp09: 'Cam sành Hàm Yên.jpg',
  rp10: 'Dưa hấu không hạt Mặt Trời Hồng.jpg',
  rp11: 'Xoài cát Chu chín cây.jpg',
  rp12: 'Dâu tây giống New Zealand (Đà Lạt).jpg',
  rp13: 'Ức gà phi lê không da.jpg',
  rp14: 'Thịt ba rọi heo CP.webp',
  rp15: 'Ba chỉ bò Mỹ cắt lát (LẩuNướng).jpg',
  rp16: 'Cá hồi Na-uy phi lê (Còn da).jpg',
  rp17: 'Tôm thẻ chân trắng tươi.jpg',
  rp18: 'Đùi gà góc tư phi lê.jpg',
  rp19: 'Sữa tươi tiệt trùng TH True Milk (Ít đường).png',
  rp20: 'Sữa chua ăn tự nhiên Vinamilk.jpg',
  rp21: 'Bánh mì gối Sandwich lạt (Kinh Đô).jpg',
  rp22: 'Bánh sừng bò Croissant bơ Pháp.jpg',
  rp23: 'Phô mai lát Cheddar Anchor.jpg',
  rp24: 'Bánh bông lan cuộn vị Dâu Tây.jpg',
  rp25: 'Cơm chiên Dương Châu đóng hộp.jpg',
  rp26: 'Gà quay tiêu kiểu Pháp (Nửa con).jpg',
  rp27: 'Salad ức gà sốt mè rang (Hộp ăn liền).jpg',
  rp28: 'Đậu hũ non sạch Ichiban.jpg',
  rp29: "Kim chi cải thảo cắt lát Ông Kim's.jpg",
  rp30: 'Trứng gà tươi sạch Ba Huân (Vỉ 6 quả).webp',
};

/** Stable Unsplash food photos — fallback for products without local images */
const img = (photoId: string) =>
  `https://images.unsplash.com/photo-${photoId}?auto=format&fit=crop&w=400&h=400&q=80`;

const localImg = (productId: string, unsplashFallback: string) => {
  const filename = LOCAL_IMAGE_MAP[productId];
  return filename ? `/${encodeURI(filename)}` : img(unsplashFallback);
};
