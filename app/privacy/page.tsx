      ...
      <div className="max-w-4xl mx-auto relative z-10">
            ...
            <div className="space-y-3 text-sm md:text-base font-medium leading-relaxed">
              ...
              <ul className="list-none space-y-2.5 pl-2">
                <li className="flex items-start gap-2.5">
                  ...
                  <span dangerouslySetInnerHTML={{ __html: t('privacy_s2_item1') }} />
                </li>
                <li className="flex items-start gap-2.5">
                  <CheckCircle2 className="w-5 h-5 text-[#057A42] dark:text-emerald-400 shrink-0 mt-0.5" />
                  <span dangerouslySetInnerHTML={{ __html: t('privacy_s2_item2') }} />
                </li>
                <li className="flex items-start gap-2.5">
                  <CheckCircle2 className="w-5 h-5 text-[#057A42] dark:text-emerald-400 shrink-0 mt-0.5" />
                  <span dangerouslySetInnerHTML={{ __html: t('privacy_s2_item3') }} />
                </li>
              </ul>
            </div>
          </section>
            ...
            <div className="space-y-3 text-sm md:text-base font-medium leading-relaxed">
              ...
              <ul className="list-none space-y-2.5 pl-2">
                <li className="flex items-start gap-2.5">
                  ...
                  <span dangerouslySetInnerHTML={{ __html: t('privacy_s3_item1') }} />
                </li>
                <li className="flex items-start gap-2.5">
                  <CheckCircle2 className="w-5 h-5 text-emerald-500 shrink-0 mt-0.5" />
                  <span dangerouslySetInnerHTML={{ __html: t('privacy_s3_item2') }} />
                </li>
                <li className="flex items-start gap-2.5">
                  <CheckCircle2 className="w-5 h-5 text-emerald-500 shrink-0 mt-0.5" />
                  <span dangerouslySetInnerHTML={{ __html: t('privacy_s3_item3') }} />
                </li>
              </ul>
            </div>
          </section>
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-between gap-4 px-4 text-xs font-bold uppercase tracking-wider text-slate-500 select-none">
          ...
          <div className="flex gap-4">
            <Link href="/terms" className="hover:text-[#057A42] dark:hover:text-emerald-400 transition-colors">{t('privacy_footer_terms')}</Link>
            <Link href="/customer/login" className="hover:text-[#057A42] dark:hover:text-emerald-400 transition-colors">{t('privacy_footer_login')}</Link>
          </div>
        </div>
      </div>
    </div>
