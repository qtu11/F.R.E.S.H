...
import { Leaf, Trees, Wind, Droplets, Info, Download, ChevronDown, ChevronUp, TrendingUp } from 'lucide-react';
import { useGlobal } from '@/app/providers';
import { showToast } from '@/lib/data/notifications';

const esgStats = [
  { icon: Trees, label: 'Trees Planted', val: '12,500', color: 'text-green-600', bg: 'bg-green-50 dark:bg-green-900/30', change: '+8%' },
  { icon: Leaf, label: 'CO2 Prevented', val: '45.2 Tons', color: 'text-[#057A42]', bg: 'bg-emerald-50 dark:bg-emerald-900/30', change: '+12%' },
  { icon: Droplets, label: 'Water Saved', val: '150k Liters', color: 'text-blue-600', bg: 'bg-blue-50 dark:bg-blue-900/30', change: '+5%' },
  { icon: Wind, label: 'Methane Reduced', val: '8.4 Tons', color: 'text-purple-600', bg: 'bg-purple-50 dark:bg-purple-900/30', change: '+3%' },
];

const districts = [
  { name: 'District 1', pct: 100, co2: '12.4 tons' },
  { name: 'District 7', pct: 85, co2: '8.2 tons' },
  { name: 'District 2', pct: 70, co2: '6.1 tons' },
  { name: 'Binh Thanh', pct: 55, co2: '4.8 tons' },
  { name: 'Tan Binh', pct: 40, co2: '3.2 tons' },
  { name: 'Go Vap', pct: 25, co2: '1.8 tons' },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="bg-white dark:bg-slate-800 rounded-3xl p-8 shadow-sm border border-gray-100 dark:border-slate-700 transition-colors">
            ...
            <div className="mt-8 space-y-3">
              {[
                { label: 'Bakery', pct: '72%', color: '#057A42' },
                { label: 'Dairy', pct: '20%', color: '#ff8c00' },
                { label: 'Produce', pct: '8%', color: '#3b82f6' },
              ].map((item, i) => (
