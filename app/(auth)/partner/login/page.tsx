...
import { Store, Lock, Mail, ArrowRight, Eye, EyeOff, ArrowLeft } from 'lucide-react';
...
function LoginForm() {
  ...
  useEffect(() => {
    const savedEmail = localStorage.getItem('remember_partner_email');
    if (savedEmail) {
      setEmail(savedEmail);
      setRememberMe(true);
    }
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (result.success) {
      ...
      if (rememberMe) {
        localStorage.setItem('remember_partner_email', email);
      } else {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white dark:bg-slate-950 relative overflow-hidden px-4 transition-colors duration-300">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-blue-600/5 dark:bg-blue-600/10 rounded-full blur-[128px]" />
        <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-[#057A42]/5 dark:bg-[#057A42]/10 rounded-full blur-[128px]" />
      </div>
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 dark:text-slate-400 text-sm font-bold tracking-widest uppercase">Store login</p>
        </div>

        <div className="bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl border border-slate-100 dark:border-slate-800/80 p-10 rounded-[2.5rem] shadow-2xl hover:shadow-blue-500/10 dark:hover:shadow-blue-500/5 hover:border-blue-500/20 dark:hover:border-blue-500/20 transition-all duration-500">
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-gray-50 dark:bg-slate-950 border border-gray-100 dark:border-slate-800/80 rounded-2xl py-4 pl-12 pr-4 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-600 dark:focus:ring-blue-400 transition-all font-bold"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-gray-50 dark:bg-slate-950 border border-gray-100 dark:border-slate-800/80 rounded-2xl py-4 pl-12 pr-12 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-600 dark:focus:ring-blue-400 transition-all font-bold"
            ...
            <div className="flex items-center justify-between pl-1">
              <label className="flex items-center gap-2 cursor-pointer select-none">
                <input 
                  ...
                  className="w-4 h-4 rounded border-gray-200 dark:border-slate-800 text-blue-600 focus:ring-blue-600 cursor-pointer"
                />
            ...
            <button 
              ...
              className="w-full bg-blue-600 hover:bg-blue-700 text-white font-black py-5 rounded-2xl transition-all flex items-center justify-center gap-3 mt-4 shadow-xl hover:shadow-blue-600/30 uppercase tracking-widest text-sm disabled:opacity-50 select-none"
            >
